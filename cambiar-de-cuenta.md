...
2. Ve al menú:
   ...
   - **macOS:** `GitHub Desktop > Preferences`
3. En la sección **Accounts**, verás la cuenta actual.
4. Haz clic en **Sign Out** (Cerrar sesión).
5. Luego, haz clic en **Sign In** (Iniciar sesión) y elige la nueva cuenta que deseas usar (puedes iniciar sesión con **GitHub.com** o **GitHub Enterprise**).
